    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2">
          <span className="text-[2rem] font-black leading-none tracking-tight md:text-[2.2rem]">{room.number}</span>
          <span
            className={cn(
              'inline-flex rounded-full border px-2.5 py-1 text-xs font-semibold md:text-sm',
        ...
        {canDrag && (
          <span className="inline-flex items-center gap-1 rounded-full border border-border/70 bg-white/80 px-2.5 py-1 text-xs text-muted-foreground">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-1.5">
        <Badge
          variant="outline"
          className={cn(
            'h-7 rounded-full px-3 text-xs font-medium md:text-sm',
        ...
        {checkoutBadge && (
          <Badge
            variant="outline"
            className={cn(
              'h-7 rounded-full px-3 text-xs font-semibold md:text-sm',
      ...
      {isOccupied ? (
        <div className="mt-3 flex-1 space-y-2">
          <div className="space-y-1">
            <p className="text-xs text-muted-foreground md:text-sm">산모</p>
            <p className="whitespace-normal break-keep text-lg font-bold leading-tight text-foreground md:text-xl">
              {room.motherName || '이름 미등록'}
            </p>
          </div>

          <div className="rounded-lg border border-border/70 bg-white/70 p-2.5">
            <p className="inline-flex items-center gap-1 text-xs font-medium text-muted-foreground md:text-sm">
          ...
          {nextUpcoming && (
            <p className="inline-flex max-w-full items-center gap-1 truncate rounded-md border border-sky-200 bg-sky-50 px-2 py-1 text-sm text-sky-700">
        ...
        <div className="mt-3 flex flex-1 flex-col justify-between rounded-xl border border-dashed border-slate-300 bg-white/55 p-3">
          <div className="flex flex-col items-center justify-center gap-2 py-1">
            ...
            <p className="text-center text-base font-semibold text-slate-700">현재 공실입니다</p>
            <p className="text-center text-sm text-muted-foreground">카드를 눌러 입실 정보를 등록하세요</p>
          </div>
          ...
          {nextUpcoming ? (
            ...
            <p className="text-center text-sm text-muted-foreground">입실 예정이 없습니다</p>
          )}
        </div>
      )}
